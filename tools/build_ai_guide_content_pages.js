...
full_page_template = `
<!-- This is an autogenerated file, edit in templates/content *.md files -->
{% extends "base-ai.html" %}

{% block page_title %}Mozilla AI Guide - TITLE{% endblock %}
...
fs.writeFileSync(full_page_filename, full_page_template.replace("PARTIAL_PATH", partial_path).replace("TITLE", page_title), 'utf8');
